                ...
                <div className='container'>
                    <div className='content'>
                        ...
                        <div className='center'>
                            <nav>
                                <ul>
                                    <li><a href='/sub1' className='main-btn'>신상품</a></li>
                                    <li><a href='/sub2' className='main-btn'>베스트</a></li>
                                    <li><a href='/sub3' className='main-btn'>알뜰상품</a></li>
                                    <li><a href='/sub4' className='main-btn'>특가/혜택</a></li>
                                </ul>
                            </nav>
                        </div>
                        <div className='right'>
