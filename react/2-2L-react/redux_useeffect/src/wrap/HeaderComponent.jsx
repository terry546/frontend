                        ...
                        <div className='content'>
                            <aside>
                                <ul>
                                    ...
                                    <li><a onClick={(e)=>onClickMenu(e, 5)} href='/sub5' className='on'>회원가입</a></li>
                                    <li><i>|</i></li>
                                    <li><a onClick={(e)=>onClickMenu(e, 6)} href='/sub6'>로그인</a></li>
                    ...
                    <div className='container'>
                        <div className='content'>
                            ...
                            <div className='center'>
                                <nav>
                                    <ul>
                                        <li><a onClick={(e)=>onClickMenu(e, 1)} href='/sub1' className='main-btn'>신상품</a></li>
                                        <li><a onClick={(e)=>onClickMenu(e, 2)}href='/sub2' className='main-btn'>베스트</a></li>
                                        <li><a onClick={(e)=>onClickMenu(e, 3)}href='/sub3' className='main-btn'>알뜰상품</a></li>
                                        <li><a onClick={(e)=>onClickMenu(e, 4)}href='/sub4' className='main-btn'>특가/혜택</a></li>
                                    </ul>
                                </nav>
                            </div>
                            <div className='right'>
